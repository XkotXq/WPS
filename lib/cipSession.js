...
// CIP directly with the session token (e.g. materials-list-cip) still need a
// real token, so they keep failing under the bypass - that's expected.
// Disabled outright in production builds so a leftover/misconfigured env
// var on a deployed instance can never let every login through.
